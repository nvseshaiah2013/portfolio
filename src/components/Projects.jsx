                ...
                <div className="flex flex-row pt-3">
                    ...
                    <div className="flex justify-center basis-4">
                        <div className="text-center">
                            ...
                            <a href="https://github.com/nvseshaiah2013/hisaab_react/" className="py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                                target={'_blank'} rel="noreferrer"
                            > See Project <FontAwesomeIcon icon={faArrowRight} /></a>
                        </div>
                    </div>
                    <div className="flex justify-center">
                        <div className="text-center">
                            ...
                            <a href="https://github.com/nvseshaiah2013/Capstone-Project/" className="py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                                target={'_blank'} rel="noreferrer"
                            > See Project <FontAwesomeIcon icon={faArrowRight} /></a>
                        </div>
                    </div>
